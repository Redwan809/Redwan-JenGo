...
export async function getAiResponse(userInput: string, history: Message[]): Promise<string> {
  ...
  const fallbackResponses = [
    "দুঃখিত, আমি আপনার কথা ঠিক বুঝতে পারিনি। 😕 দয়া করে একটু সহজভাবে বা অন্যভাবে জিজ্ঞেস করবেন?",
    "আমি ঠিক বুঝতে পারছি না। আপনি কি অন্যভাবে বলতে পারেন? 🤔",
    "আমার মনে হচ্ছে আমি আপনার প্রশ্নটি বুঝতে পারছি না। আরেকবার চেষ্টা করবেন? 😟",
    "হুম, এটা আমার জন্য একটু কঠিন। আরও কিছু তথ্য দিলে হয়তো বুঝতে পারবো। 📖",
    "এই বিষয়টি আমার এখনো শেখা হয়নি। আপনি কি আমাকে একটি উদাহরণ দিতে পারেন? 📚"
  ];
