...
/**
 * @fileOverview Summarizes the recent chat history.
 *
 * - summarizeChatHistory - A function that summarizes the recent chat history.
...
const SummarizeChatHistoryOutputSchema = z.object({
  summary: z.string().describe('A short summary of the chat history.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `Summarize the following chat history in a concise way:\n\n{{chatHistory}}`,
});
